...
/**
 * mcm_device_xrandr_get_edid_md5:
 **/
const gchar *
mcm_device_xrandr_get_edid_md5 (McmDeviceXrandr *device_xrandr)
{
...
mcm_device_xrandr_set_from_output (McmDevice *device, MateRROutput *output, GError **error)
{
	...
	priv->edid_md5 = g_strdup (mcm_edid_get_checksum (priv->edid));
...
/**
 * mcm_device_xrandr_get_config_data:
 **/
static gchar *
mcm_device_xrandr_get_config_data (McmDevice *device)
{
...
/**
 * mcm_device_xrandr_is_primary:
 *
 * Return value: %TRUE is the monitor is left-most
 **/
gboolean
mcm_device_xrandr_is_primary (McmDeviceXrandr *device_xrandr)
{
	gint x, y;
	gboolean ret = FALSE;
...
mcm_device_xrandr_class_init (McmDeviceXrandrClass *klass)
{
	...
	device_class->get_config_data = mcm_device_xrandr_get_config_data;
