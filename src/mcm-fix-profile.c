...
/**
 * mcm_fix_profile_error_cb:
 **/
static void
mcm_fix_profile_error_cb (cmsContext ContextID, cmsUInt32Number errorcode, const char *text)
{
...
main (int argc, char **argv)
{
	...
	/* setup LCMS */
	cmsSetLogErrorHandler (mcm_fix_profile_error_cb);
